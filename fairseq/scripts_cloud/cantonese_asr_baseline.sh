...
model_name=canto_asr_transformer_xs_lr_0.003_vocab_size_8000_unigram_no_specaugment
...
for test in  test_asr_CoVoHK ;
do
python /home/rita/cantonese-asr/fairseq/fairseq_cli/generate.py ${DATA_ROOT} --config-yaml config_asr_unigram.yaml --gen-subset ${test} \
...
generated_file_CoVoHK=${SAVE_DIR}/generate-test_asr_CoVoHK.txt
