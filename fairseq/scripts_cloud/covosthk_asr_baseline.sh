...
model_name=covost_asr_transformer_s_lr_0.003_vocab_size_8000_unigram_no_specaugment
...
# # # #testing      
python /home/rita/cantonese-asr/fairseq/fairseq_cli/generate.py ${DATA_ROOT} --config-yaml config_asr_no_specaugment.yaml  --gen-subset test_asr_ours \
    --task speech_to_text --path ${SAVE_DIR}/${CHECKPOINT_FILENAME} --arch s2t_transformer_s  \
